...
//  InteractiveStory
//
//  Created by Eduardo Velez on 5/30/19.
...
extension Story{
    var artwork: UIImage {
        switch self {
        case .returnTrip:
            return UIImage(named: "ReturnTrip")!
        case .touchDown:
            return UIImage(named: "TouchDown")!
        case .homeward:
            return UIImage(named: "Homeward")!
        case .rover:
            return UIImage(named: "Rover")!
        case .cave:
            return UIImage(named: "Cave")!
        case .crate:
            return UIImage(named: "Crate")!
        case .monster:
            return UIImage(named: "Monster")!
        case .droid:
            return UIImage(named: "Droid")!
        case .home:
